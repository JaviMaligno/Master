...
Throughout this report, $k$ will denote a commutative base ring which is supposed to act everywhere, i.e. we work over the category of $k$-modules. In the main results, we will assume that $k$ is a field of characteristic 0. Any map between topological spaces is required to be continuous. We also adopt the convention that the natural numbers inlclude 0.
