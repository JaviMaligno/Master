...
\begin{frame}
	\begin{itemize}
		...
		$$
		d(a_1\otimes\cdots\otimes a_n)=\pi(a_1)a_2\otimes\cdots\otimes a_n-a_1a_2\otimes \cdots\otimes a_n+\cdots$$ $$\cdots+(-1)^{n}a_1\otimes\cdots\otimes a_{n-1}\pi(a_n).$$ %comentar que a esto se llega en varios pasos previos, tal como comento en el trabajo
