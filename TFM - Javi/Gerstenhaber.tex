...
\end{itemize}
\item[(3)]  $[a,]$ is a right derivation of $\cdot$ of degree $|a|-1$:%$[,c]$ is a left derivation of $\cdot$ of degree $|c|-1$: %LO QUE PRUEBA GERSTENHABER ES CON EL PRODUCTO EN EL LADO IZQUIERDO PERO SUPONGO QUE POR LA CONMUTATIVIDAD Y ANTISIMETRÍA
%\[
