...
ESTO ALOMEJOR LO PONGO DESPUÉS In any other symmetric monoidal category the definition works just as fine performing the obvious substitutions, and the equivalence mentioned before remains true by the well-known andjunction $\Hom(X\otimes Y,Z)\cong\Hom(X,\Hom(Y,Z))$ REFERENCIARLA EN ALGÚN LAO O PROBARLA. 
...
ALGEBRA OVER AN OPERAD, PRIMERO INTRODUCIR EL DE ENDOMORFISMOS
\url{https://ncatlab.org/nlab/show/algebra+over+an+operad}
\begin{defi}
\end{defi}


COMENTAR QUE UN MORFISMO DE OPERAD INDUCE ESTRUCTURA DE ÁLGEBRA SOBRE LA PRIMERA, PARA ESO ALOMEJOR NECESITO LA ADJUNCIÓN TENSOR HOM PERO NO ESTOY SEGURO


PONER EN ALGUNA PARTE LA EQUIVALENCIA ENTRE ALGEBRAS DE GERSTENHABER Y ÁLGEBRAS SOBRE LA HOMOLOGÍA DEL OPERAD, A VER SI PUEDO DAR BIEN LA REFERENCIA ENTRE MAY Y COHEN, SI NO PREGUNTAR A MURO
