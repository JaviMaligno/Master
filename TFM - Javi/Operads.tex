...
\] 
The reader is referred to page 194 of \cite{Yau} and to \cite{tesis} to see the diagrams associated to the axioms. We won't need to show them explicitly since in most cases one can just mimic the definition \ref{operadtop}. PUEDO COGERLO DE LA TESIS PARA COMPLETARLO SI TENGO TIEMPO
\end{enumerate}
