...
\caption{A point $c\in E_2(3)$.}
 ...
 We define for all positive integers $p$ and $q$ and  each $1\leq i\leq p$ the insertion map 
 \[
...
The reverse process of obtaining an operad from an algebraic structure is very natural and standard. We will do it explicitly for the case of Gerstenhaber algebras later when we need them, but to give a feel of how this works, one can describe --for instance-- a commutative product as an operation $\mu\in H_0(E_2(2))$ (degree 0 and arity 2) satisfying $\mu=(12)\mu$, where $(12)\in\Sigma_2$ by rearranging the arguments. 
