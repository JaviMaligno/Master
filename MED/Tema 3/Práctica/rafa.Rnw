...
pvalor 
@
Que el $p$-valor sea $0$ nos dice que el modelo no est\'a bien ajustado, luego ser\'a necesario hacer un an\'alisis para corregir los defectos que pueda tener.
