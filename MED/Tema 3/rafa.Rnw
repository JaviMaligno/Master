...
En nuestro caso particular tenemos que la variable GRE apenas tienen asociaci\'on. La variable GPA est\'a m\'as intensamente relacionada, pues un aumento en una unidad de GPA suponiendo el resto constante se traduce en un aumento de la odd ratio en $2.23$. 
\end{itemize}
\end{ejercicio}
\end{document}