...
\newpage
\begin{ejercicio}
Calcular los caracteres del álgebra exterior de la representación estándar de $S_4$.
\end{ejercicio}
\begin{solucion}
...
$$ 
donde $w$ es una raíz primitiva $m$-ésima de la unidad. Tomando, por ejemplo $x=e_1$, $y=e_2$ tenemos que $e_1^j e_2^{m-j}$ $\forall j=0,\dotsc, m$. Recursivamente, tenemos que todos los elementos de la base están dentro.
\end{solucion}
