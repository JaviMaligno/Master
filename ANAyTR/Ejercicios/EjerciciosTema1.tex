...
\begin{enumerate}[(a)]
\item[]
\item Supongamos que $V$ es irreducible. Si todos los vectores no son cíclicos, $\exists w$ no cíclico. En ese caso $Aw$ está estrictamente contenido en $V$ y, además, es un subespacio vectorial. Además, para todo $z \in Aw$ y $\forall a \in A$ y $b \in A$ tales que
$$
