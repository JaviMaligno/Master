...
$$ 
donde $w$ es una raíz primitiva $m$-ésima de la unidad. Tomando, por ejemplo $x=e_1$, $y=e_2$ tenemos que $e_1^j e_2^{m-j}$ $\forall j=0,\to m$. Recursivamente, tenemos que todos los elementos de la base están dentro.
\end{solucion}
