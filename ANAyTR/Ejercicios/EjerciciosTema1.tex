...
$$
\item Consideremos $A[n]$ como el espacio vectorial generado por caminos entre cualesquiera vértices que tienen longitud (y por tanto, grado) $n$. Esos caminos están precisamente dados por la suma de todos los elementos de $M_Q^n$. Por tanto, considerando $|\cdot|$ la norma matricial dada por la suma de los valores absolutos de todos los coeficientes, tenemos que 
$$
h_A(t) = \sum_{n\geq 0} \dim(A[n])t^n =  \sum_{n\geq 0} |M_Q^n|t^n 
$$
