...
\end{tikzcd}
\]
Tenemos que $\pi^{-1}(\alpha)$ es el conjunto de puntos $(t,x,y)\in\A_k^3$ tales que $ty-x^2=0$ y $t=\alpha$. Para $\alpha=0$ obtenemos los puntos $(\alpha,0,y)$, que es una recta. Esto nos da la imagen geométrica siguiente COPIAR IMAGEN DE HARTSHORNE 3.3.1 
