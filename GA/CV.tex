...
\rhead{Topología Algebraica (Máster en Matemáticas)}
...
\begin{titlepage}
	\centering
	{\huge\bfseries Topología Algebraica \par}
	\vspace{2cm}
...
Gran parte de esta obra es una traducción de los capítulos 2 y 3 del libro \emph{Algebraic Topology} de Allen Hatcher, que puede encontrarse en el siguiente enlace: \url{http://pi.math.cornell.edu/~hatcher/AT/AT.pdf}
