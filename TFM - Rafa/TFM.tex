...
En esta sección presentamos algunas aplicaciones y otros problemas conocidos que guardan cierta relación con el problema del emparejamiento.
...
\subsection{T-Enlaces y T-Cortes}
Continuamos presentando la relación entre los emparejamientos y los $T$-enlaces y $T$-cortes, conceptos capitales para resolver el problema del cartero.
\begin{defi}
